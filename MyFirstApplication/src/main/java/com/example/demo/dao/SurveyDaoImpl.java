...
public class SurveyDaoImpl implements SurveyDao {
	...
	public void insertSurvey(Survey survey) {
		jdbcTemplate.update("INSERT INTO survey(age, satisfaction, comment) VALUES(?, ?, ?)",
				survey.getAge(), survey.getSatisfaction(), survey.getComment());
	}

	@Override
	public List<Survey> getAll() {
		String sql = "SELECT id, age, satisfaction, comment FROM survey";
